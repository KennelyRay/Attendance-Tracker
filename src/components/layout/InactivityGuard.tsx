...
export function InactivityGuard({ isAdmin = false }: { isAdmin?: boolean }) {
  ...
  return (
    <div className="app-overlay-scroll bg-slate-950/75 backdrop-blur-sm">
      <div className="app-overlay-panel max-w-md rounded-3xl border border-sky-400/15 bg-slate-950/95 p-4 shadow-[0_28px_80px_rgba(8,6,4,0.65)] ring-1 ring-inset ring-white/5 sm:p-6">
